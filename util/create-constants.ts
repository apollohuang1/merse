...
export const storyboardSamples: StoryboardSample[] = [
  ...
  },
  {
    ...
    text: "The rain comes down hard, but we take off running, hand in hand, laughing and splashing through puddles. We're soaked to the bone, but we don't care. As we reach our doorstep, we share a deep kiss, knowing that this is where we belong - together, in the safety and comfort of our love.",
  },
  {
    artwork: {
