...
import { FiArrowUpRight, FiBookOpen, FiChevronRight, FiLogOut, FiUser } from "react-icons/fi";
import MerseLogo from "./svgs/merse-logo";
import { Menu, MenuButton, MenuItem, MenuList, Spinner } from "@chakra-ui/react";
import { midjourneyGeneratedImages, teamMembers } from "@/util/landing-constant";
...
const Landing = (props: Props) => {
  ...
  const [isDemoVidePlaying, setIsDemoVideoPlaying] = React.useState<boolean>(true);
